...
public class UpdateFavdb extends AsyncTask<Void, Void, Void> {
    ...
    public UpdateFavdb(Context context, CinemaMovieListModel movie, DBUpdateListener updateListener) {
...
//        addMovie();
    ...
    public void addMovie() {
        ...
        if (favMovieCursor.moveToFirst()) {
            ...
            values.put(MovieContract.MovieEntry.COLUMN_POSTER_IMAGE, mMovie.getImageurl());
            values.put(MovieContract.MovieEntry.COLUMN_OVERVIEW, mMovie.getSynopsis());
            values.put(MovieContract.MovieEntry.COLUMN_AVERAGE_RATING, mMovie.getRating());
            values.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, mMovie.getRelease_date());
            values.put(MovieContract.MovieEntry.COLUMN_BACK_POSTER, mMovie.getBackPoster());
